...
// Importamos los datos simulados que creamos en servicios/mockData.js
...
export default function DashboardCliente() {
  ...
  return (
    <div style={styles.container}>
      ...
      {/* BARRA SUPERIOR DEL PANEL DE CLIENTE */}
      <header style={styles.navbar}>
        ...
        <div style={styles.userMenu}>
          <span style={styles.userName}>Hola, Daniel</span>
      ...
      <main style={styles.content}>
        ...
        {/* SECCIÓN 1: MIS RESERVAS PROGRAMADAS */}
        ...
        {/* SECCIÓN 2: CATÁLOGO DE SERVICIOS PARA AGENDAR */}
        <section style={styles.section}>
          <h2 style={styles.sectionTitle}>
            ...
            {servicios.map((servicio) => (
              <div key={servicio.id} style={styles.servicioCard}>
                ...
                <div style={styles.servicioCardFooter}>
                  ...
                  <button style={styles.btnBook}>Agendar cita</button>
                </div>
              </div>
            ))}
          </div>
